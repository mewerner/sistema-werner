...
const Sheets = {
  ...
  async inicializarAbas() {
    const abas = {
      ...
      [CONFIG.SHEETS.CONTAS_PAGAR]: ['id','fornecedor_id','fornecedor_nome','projeto_id','numero_nf','descricao','valor_total','parcela_num','parcela_total','valor_parcela','data_emissao','data_vencimento','data_pagamento','forma_pagamento','categoria','status','observacoes','financiamento_id','criado_em'],
